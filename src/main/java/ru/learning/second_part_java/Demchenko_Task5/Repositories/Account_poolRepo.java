...
public interface Account_poolRepo extends JpaRepository<Account_pool, Integer> {
    ...
    Account_pool selectAcc_poolFromAcc_pool_1param(@Param("registry_type_code") String registry_type_code);
    ...
    Account_pool selectAcc_poolFromAcc_pool_5param(@Param("branch_code") String branch_code,
