...
public interface AccountRepo extends JpaRepository<Account, Integer> {
    ...
    List<Account> selectAcсount_FromAccount_1param(@Param("account_pool_id") Integer account_pool_id);
    ...
    List<Account> selectAcсount_FromAccount_2param(@Param("account_number") String account_number);
